...
class MainActivity : AppCompatActivity(), GroceryRVAdapter.GroceryItemClickInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        groceryRVAdapter = GroceryRVAdapter(list, groceryItemClickInterface = this)
    ...
    fun openDialog() {
        ...
        val itemQunatityEdt = dialog.findViewById<EditText>(R.id.idEditItemQuantity)
        ...
        addBtn.setOnClickListener {
            ...
            if(itemName.isNotEmpty() && itemPrice.isNotEmpty() && itemQuantity.isNotEmpty()){
                ...
                Toast.makeText(applicationContext, "Pleas enter Data", Toast.LENGTH_SHORT).show()
            }
        }
